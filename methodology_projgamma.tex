...
To effectively employ the sample space for a joint Metropolis step, as well as
    speeding convergence, we employ a parallel tempering algorithm\citep{earl2005} 
