...
%    developed in~\cite{COOLEY2010}.  
    ...
    generate new clusters more readily.  For the simulated data,} 
    ...
    centering distribution appears to \makenote{somewhat} negatively affect model 
    fidelity.  \makenote{Additionally, the log-normal models with the additional computational cost
    of multivariate normal evaluation and parallel tempering, take approximately six times
    longer to sample relative to the gamma models.}
