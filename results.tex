...
\begin{figure}[tb]
    \centering
    \caption{Energy score (top) and Posterior Predictive Loss (bottom) for various models on simulated data with ascending count of mixture components (indicated by plot heading).  Gen indicates baseline.\label{fig:simpples}}
