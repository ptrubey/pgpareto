...
\makenote{this title seems weird?}
...
Figure~\ref{fig:simpples} shows the average rise over baseline in energy score as
    ...
    developed in~\cite{COOLEY2010}.  Note that the pairwise betas model respects
    ...
    simulation study.}  We observe that the projected gamma models dominate, and within
    that class of model, the choice of centering distribution is irrelevant.  For the
    projected \emph{restricted} gamma models, the choice of a multivariate log-normal 
    centering distribution negatively affects model fidelity.
